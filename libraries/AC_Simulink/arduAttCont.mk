###########################################################################
## Makefile generated for component 'arduAttCont'. 
## 
## Makefile     : arduAttCont.mk
## Generated on : Thu Apr 11 11:29:26 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\arduAttCont.exe
...
COMPILER_COMMAND_FILE     = arduAttCont_comp.rsp
CMD_FILE                  = arduAttCont.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\arduAttCont.exe
...
DEFINES_STANDARD = -DMODEL=arduAttCont -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\arduAttCont_ert_rtw\arduAttCont.cpp $(START_DIR)\arduAttCont_ert_rtw\arduAttCont_data.cpp
...
OBJS = arduAttCont.obj arduAttCont_data.obj
...
{$(START_DIR)\arduAttCont_ert_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\arduAttCont_ert_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\arduAttCont_ert_rtw}.cc.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\arduAttCont_ert_rtw}.cxx.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
arduAttCont.obj : "$(START_DIR)\arduAttCont_ert_rtw\arduAttCont.cpp"
	$(CPP) $(CPPFLAGS) -Fo"$@" "$(START_DIR)\arduAttCont_ert_rtw\arduAttCont.cpp"


arduAttCont_data.obj : "$(START_DIR)\arduAttCont_ert_rtw\arduAttCont_data.cpp"
	$(CPP) $(CPPFLAGS) -Fo"$@" "$(START_DIR)\arduAttCont_ert_rtw\arduAttCont_data.cpp"
