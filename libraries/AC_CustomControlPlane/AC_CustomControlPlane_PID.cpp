...
#if AP_CUSTOMCONTROLPLANE_PID_ENABLED

#include "AC_CustomControlPlane_PID.h"
#include "AC_AttitudeControl/AC_AttitudeControl_Multi.h"

// table of user settable parameters
const AP_Param::GroupInfo AC_CustomControlPlane_PID::var_info[] = {
    // @Param: ANG_RLL_P
    ...
    // @User: Standard
    AP_SUBGROUPINFO(_p_angle_roll2, "ANG_RLL_", 1, AC_CustomControlPlane_PID, AC_P),
    ...
    // @Range{Sub}: 0.0 12.000
    // @User: Standard
    AP_SUBGROUPINFO(_p_angle_pitch2, "ANG_PIT_", 2, AC_CustomControlPlane_PID, AC_P),
    ...
    // @Range{Sub}: 0.0 6.000
    // @User: Standard    
    AP_SUBGROUPINFO(_p_angle_yaw2, "ANG_YAW_", 3, AC_CustomControlPlane_PID, AC_P),
    ...
    AP_SUBGROUPINFO(_pid_atti_rate_roll, "RAT_RLL_", 4, AC_CustomControlPlane_PID, AC_PID),
    ...
    AP_SUBGROUPINFO(_pid_atti_rate_pitch, "RAT_PIT_", 5, AC_CustomControlPlane_PID, AC_PID),
    ...
    AP_SUBGROUPINFO(_pid_atti_rate_yaw, "RAT_YAW_", 6, AC_CustomControlPlane_PID, AC_PID),

    AP_GROUPEND
};

AC_CustomControlPlane_PID::AC_CustomControlPlane_PID(AC_CustomControlPlane& frontend, AP_AHRS_View*& ahrs, AC_AttitudeControl*& att_control, AP_MotorsMulticopter*& motors, float dt) :
...
Vector3f AC_CustomControlPlane_PID::update()
{
...
void AC_CustomControlPlane_PID::reset(void)
{
...
void AC_CustomControlPlane_PID::set_notch_sample_rate(float sample_rate)
{
...
#endif  // AP_CUSTOMCONTROLPLANE_PID_ENABLED
