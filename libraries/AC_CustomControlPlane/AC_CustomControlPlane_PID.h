...
class AC_CustomControlPlane_PID : public AC_CustomControlPlane_Backend {
public:
    AC_CustomControlPlane_PID(AC_CustomControlPlane& frontend, AP_AHRS_View*& ahrs, AC_AttitudeControl*& att_control, AP_MotorsMulticopter*& motors, float dt);
