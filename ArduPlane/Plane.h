...
#include <AC_CustomControlPlane/AC_CustomControlPlane.h>                  // Custom control library
#endif
...
#if AC_CUSTOMCONTROLPLANE_MULTI_ENABLED == ENABLED
    AC_CustomControlPlane custom_control{ahrs_view, attitude_control, motors, scheduler.get_loop_period_s()};
#endif
